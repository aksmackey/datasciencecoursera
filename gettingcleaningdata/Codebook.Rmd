...
## Project Description
This function cleans the UCI HAR Dataset into a usable form and calculates the mean of each variable for each Subject/Activity combination. 
...
The code is described in further detail at: https://github.com/aksmackey/datasciencecoursera/blob/master/gettingcleaningdata/README.rmd
